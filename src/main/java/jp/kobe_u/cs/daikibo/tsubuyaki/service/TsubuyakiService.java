...
public class TsubuyakiService {
    ...
    // キーワードを含むつぶやきを検索して取得
    public ArrayList<Tsubuyaki> searchTsubuyaki(String key) {
        Iterable<Tsubuyaki> searched = repo.findByCommentLike("%" + key + "%");
        ArrayList<Tsubuyaki> list = new ArrayList<Tsubuyaki>();
